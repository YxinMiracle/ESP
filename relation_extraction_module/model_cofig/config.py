...
def get_params():
    ...
    parser.add_argument("--bert_model_name", type=str, default="bert-base-cased",
                        help="model name")
    parser.add_argument("--data_directory_name", type=str, default="ade", help="data directory name")
    ...
    parser.add_argument("--llm_model_path", type=str, default="Qwen2-72B-Instruct", help="llm model path")
    parser.add_argument("--shuffle", type=bool, default=True)
    parser.add_argument("--saved_model_name", type=str, default="model.pt")
